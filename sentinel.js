...
const endpoints = [
    {host: 'redis-cluster.integracion.svc.cluster.local', port: 6379}, 
    {host: 'redis.integracion.svc.cluster.local', port: 6379},
    {host: 'redis-sentinel.integracion.svc.cluster.locall', port: 5000}
];
